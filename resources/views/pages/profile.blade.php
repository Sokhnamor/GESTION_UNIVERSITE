...
<body class="bg-background-light dark:bg-background-dark text-[#0d121b] dark:text-white transition-colors duration-200">
    <div class="relative flex h-screen w-full flex-col overflow-hidden">
        ...
        <header class="flex items-center justify-between whitespace-nowrap border-b border-solid border-[#e7ebf3] dark:border-gray-800 bg-white dark:bg-[#1a2230] px-6 py-3 shrink-0 z-20">
            ...
            <div class="flex flex-1 justify-end gap-8 items-center">
                ...
                <div class="flex items-center gap-4">
                    <button class="hidden sm:flex min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-10 px-4 bg-primary text-white hover:bg-blue-700 transition-colors text-sm font-bold leading-normal tracking-[0.015em]">
                        <span class="truncate">Déconnexion</span>
                    </button>
                    <div class="bg-center bg-no-repeat aspect-square bg-cover rounded-full size-10 border border-[#e7ebf3] dark:border-gray-700" data-alt="User profile picture placeholder" style='background-image: url("https://lh3.googleusercontent.com/aida-public/AB6AXuCfQhVgWeTXC5SLO1gKUcbNEtuNTClWn97ljsj58VNfIQpkCM2lNPxyMPenWLvr18Y38nkxodSVzMhijgDHiXhYhtlFrvtpktj-jyPrhKscl-34KiYfWBFCClw9nZNKA2EKMrolHj1RfSGd5cl19PeG37nxf-MmfDzCqzhEeDAK7mfpo06TyurY3UPiWKOOD-KHCKjkJStJa8M5N8A1_MXosYHlhJa-vPmQByNczYwFrT5b9pE_7pyXt1SerLkCAO79xB_Ly8pBiEY");'></div>
                </div>
            </div>
        </header>
        ...
        <div class="flex flex-1 overflow-hidden">
                ...
                <div class="flex flex-col p-6 h-full justify-between">
                    <div class="flex flex-col gap-6">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[#4c669a] dark:text-gray-400 hover:text-[#0d121b] dark:hover:text-gray-200" href="#informations-personnelles">
                                <span class="material-symbols-outlined">person</span>
                                <p class="text-sm font-medium leading-normal">Informations Personnelles</p>
                            </a>
                            <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[#4c669a] dark:text-gray-400 hover:text-[#0d121b] dark:hover:text-gray-200" href="#roles-permissions">
                                <span class="material-symbols-outlined">shield_person</span>
                                <p class="text-sm font-medium leading-normal">Rôles &amp; Permissions</p>
                            </a>
                            <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[#4c669a] dark:text-gray-400 hover:text-[#0d121b] dark:hover:text-gray-200" href="#securite">
                                <span class="material-symbols-outlined">lock</span>
                                <p class="text-sm font-medium leading-normal">Sécurité</p>
                            </a>
                            <a class="flex items-center gap-3 px-3 py-2.5 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors text-[#4c669a] dark:text-gray-400 hover:text-[#0d121b] dark:hover:text-gray-200" href="#notifications">
            ...
            <main class="flex-1 overflow-y-auto bg-background-light dark:bg-background-dark p-4 lg:p-10 scroll-smooth">
                <div class="max-w-[960px] mx-auto flex flex-col gap-8 pb-20">
                    ...
                    <section id="informations-personnelles" class="bg-white dark:bg-[#1a2230] rounded-xl border border-[#e7ebf3] dark:border-gray-800 p-6 shadow-sm">
                    ...
                    <!-- Roles & Permissions -->
                    <section id="roles-permissions" class="bg-white dark:bg-[#1a2230] rounded-xl border border-[#e7ebf3] dark:border-gray-800 p-6 shadow-sm">
                        <div class="flex items-center gap-3 mb-6 border-b border-[#e7ebf3] dark:border-gray-800 pb-4">
                    ...
                    <!-- Security Section -->
                    <section id="securite" class="bg-white dark:bg-[#1a2230] rounded-xl border border-[#e7ebf3] dark:border-gray-800 p-6 shadow-sm">
                        <div class="flex items-center gap-3 mb-6 border-b border-[#e7ebf3] dark:border-gray-800 pb-4">
                        ...
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                            ...
                            <div class="flex flex-col gap-4">
                                ...
                                <form method="POST" action="{{ route('profile.update') }}">
                                    ...
                                    <div class="flex flex-col gap-3">
                                        <div class="flex flex-col gap-1">
                                            <label class="text-[#4c669a] dark:text-gray-400 text-xs font-medium uppercase" for="currentPwd">
                                                Mot de passe actuel
                                            </label>
                                            <div class="relative">
                                                <input
                                                    class="bg-[#f8f9fc] dark:bg-gray-800 border border-[#e7ebf3] dark:border-gray-700 text-[#0d121b] dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5 pr-10"
                                                    id="currentPwd"
                                                    type="password"
                                        ...
                                        <div class="flex flex-col gap-1">
                                            <label class="text-[#4c669a] dark:text-gray-400 text-xs font-medium uppercase" for="newPwd">
                                                Nouveau mot de passe
                                            </label>
                                            <input
                                                class="bg-[#f8f9fc] dark:bg-gray-800 border border-[#e7ebf3] dark:border-gray-700 text-[#0d121b] dark:text-white text-sm rounded-lg focus:ring-primary focus:border-primary block w-full p-2.5"
                                                id="newPwd"
                                                type="password"
                                                name="password"
                                        ...
                                        <div class="flex flex-col gap-1">
                                            <label class="text-[#4c669a] dark:text-gray-400 text-xs font-medium uppercase" for="confirmPwd">
                                        ...
                                        <button type="submit" class="mt-2 w-fit px-4 py-2 bg-white dark:bg-gray-700 border border-[#e7ebf3] dark:border-gray-600 rounded-lg text-sm font-medium text-[#0d121b] dark:text-white hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors">
                                            Mettre à jour
                                        </button>
                                    </div>
                                </form>
                            ...
                            <div class="flex flex-col gap-6">
                                ...
                                <div class="flex flex-col gap-4">
                                    ...
                                    <p class="text-sm text-[#4c669a] dark:text-gray-400">Dernière connexion : <span class="font-medium text-[#0d121b] dark:text-gray-200">Aujourd'hui à 09:42</span> (Paris, FR)</p>
                                    <button class="flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-lg border border-red-200 dark:border-red-900 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 text-sm font-bold hover:bg-red-100 dark:hover:bg-red-900/30 transition-colors">
                    ...
                    <section id="notifications" class="bg-white dark:bg-[#1a2230] rounded-xl border border-[#e7ebf3] dark:border-gray-800 p-6 shadow-sm">
                        <div class="flex items-center gap-3 mb-6 border-b border-[#e7ebf3] dark:border-gray-800 pb-4">
                            <span class="material-symbols-outlined text-primary">notifications</span>
                            <h2 class="text-lg font-bold text-[#0d121b] dark:text-white">Notifications</h2>
                        </div>
                        <div class="grid grid-cols-1 gap-6">
                            <div class="flex items-center justify-between p-4 rounded-lg border border-[#e7ebf3] dark:border-gray-700">
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-[#0d121b] dark:text-white">Notifications par email</span>
                                    <span class="text-xs text-[#4c669a] dark:text-gray-400">Recevez des mails pour les nouveaux scans et mises à jour.</span>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <input checked="" class="sr-only peer" type="checkbox" value=""/>
                                    <div class="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300 dark:peer-focus:ring-blue-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-gray-600 peer-checked:bg-primary"></div>
                            ...
                            <div class="flex items-center justify-between p-4 rounded-lg border border-[#e7ebf3] dark:border-gray-700">
                                <div class="flex flex-col">
                                    <span class="text-sm font-medium text-[#0d121b] dark:text-white">Notifications push</span>
                                    <span class="text-xs text-[#4c669a] dark:text-gray-400">Recevez des notifications en temps réel.</span>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer">
    ...
    <!-- JavaScript pour le défilement fluide et la gestion de l'état actif -->
    <script>
    document.addEventListener('DOMContentLoaded', function() {
        // Sélectionne tous les liens de la sidebar qui ont un href commençant par #
        ...
        sidebarLinks.forEach(link => {
            link.addEventListener('click', function(e) {
                ...
                if (targetElement) {
                    ...
                    // Met à jour les styles de la sidebar
                    updateSidebarActiveState(targetId);
                }
            });
        });
        
        // Fonction pour mettre à jour l'état actif dans la sidebar
        function updateSidebarActiveState(activeId) {
            sidebarLinks.forEach(link => {
                // Réinitialise tous les liens
                link.classList.remove('bg-primary/10', 'border-l-4', 'border-primary', 'text-primary');
                link.classList.add('text-[#4c669a]', 'dark:text-gray-400', 'hover:text-[#0d121b]', 'dark:hover:text-gray-200');
                
                // Supprime la classe fill des icônes
            ...
            // Ajoute les classes à l'élément actif
            const activeLink = document.querySelector(`aside a[href="#${activeId}"]`);
            if (activeLink) {
                activeLink.classList.add('bg-primary/10', 'border-l-4', 'border-primary');
                activeLink.classList.remove('text-[#4c669a]', 'dark:text-gray-400', 'hover:text-[#0d121b]', 'dark:hover:text-gray-200');
                activeLink.classList.add('text-primary');
                
                // Ajoute la classe fill à l'icône
        ...
        // Met à jour l'état actif au chargement basé sur le hash de l'URL
        if (window.location.hash) {
            const hash = window.location.hash.substring(1);
            updateSidebarActiveState(hash);
        }
        
        // Met également à jour l'état actif lors du défilement (optionnel)
